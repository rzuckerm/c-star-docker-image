C-STAR_VERSION := $(shell cat C-STAR_VERSION)
C-STAR_DEPS := $(wildcard C-STAR_*)
DOCKER_TAG_PREFIX := rzuckerm/c-star:$(C-STAR_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(C-STAR_DEPS)
